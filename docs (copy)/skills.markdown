...
- <label for="file">Italian</label> <progress id="file" value="70" max="100"> 70% </progress>
- <label for="file">Swiss German</label> <progress id="file" value="50" max="100"> 15% </progress>
- <label for="file">Russian</label> <progress id="file" value="10" max="100"> 10% </progress>
- <label for="file">Turkish</label> <progress id="file" value="10" max="100"> 10% </progress>
